...
class LibUVC {
  ...
  uvc_error uvc_wrap(
    int sys_dev,
    ffi.Pointer<uvc_context_t> context,
    ffi.Pointer<ffi.Pointer<uvc_device_handle_t>> devh,
  ) {
    return uvc_error.fromValue(_uvc_wrap(
      sys_dev,
      context,
      devh,
    ));
  ...
  late final _uvc_wrapPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Int, ffi.Pointer<uvc_context_t>,
              ffi.Pointer<ffi.Pointer<uvc_device_handle_t>>)>>('uvc_wrap');
  late final _uvc_wrap = _uvc_wrapPtr.asFunction<
      int Function(int, ffi.Pointer<uvc_context_t>,
