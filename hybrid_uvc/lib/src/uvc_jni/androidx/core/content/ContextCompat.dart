...
import '../../../android/view/Display.dart' as display_;
...
class ContextCompat extends jni.JObject {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static display_.Display getDisplayOrDefault(
    jni.JObject context,
  ) {
    return _getDisplayOrDefault(
            ...
            context.reference.pointer)
        .object(const display_.$DisplayType());
  }
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static jni.JObject getContextForLanguage(
    jni.JObject context,
  ) {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static jni.JObject createAttributionContext(
    jni.JObject context,
    jni.JString string,
  ) {
