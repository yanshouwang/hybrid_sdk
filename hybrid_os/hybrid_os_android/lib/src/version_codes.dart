...
abstract final class VersionCodes {
  ...
  static int get base => jni.Build_VERSION_CODES.BASE;
  ...
  ///
  /// Added in API level 4
  static int get base1_1 => jni.Build_VERSION_CODES.BASE_1_1;
  ...
  ///
  /// Added in API level 4
  static int get cupcake => jni.Build_VERSION_CODES.CUPCAKE;
  ...
  ///
  /// Added in API level 4
  static int get curDevelopment => jni.Build_VERSION_CODES.CUR_DEVELOPMENT;
  ...
  ///
  /// Added in API level 4
  static int get donut => jni.Build_VERSION_CODES.DONUT;
  ...
  static int get eclair => jni.Build_VERSION_CODES.ECLAIR;
  ...
  static int get eclair0_1 => jni.Build_VERSION_CODES.ECLAIR_0_1;
  ...
  static int get eclairMR1 => jni.Build_VERSION_CODES.ECLAIR_MR1;
  ...
  static int get froyo => jni.Build_VERSION_CODES.FROYO;
  ...
  static int get gingerbread => jni.Build_VERSION_CODES.GINGERBREAD;
  ...
  static int get gingerbreadMR1 => jni.Build_VERSION_CODES.GINGERBREAD_MR1;
  ...
  static int get honeycomb => jni.Build_VERSION_CODES.HONEYCOMB;
  ...
  static int get honeycombMR1 => jni.Build_VERSION_CODES.HONEYCOMB_MR1;
  ...
  static int get honeycombMR2 => jni.Build_VERSION_CODES.HONEYCOMB_MR2;
  ...
  static int get iceCreamSandwich => jni.Build_VERSION_CODES.ICE_CREAM_SANDWICH;
  ...
  static int get iceCreamSandwichMR1 =>
      jni.Build_VERSION_CODES.ICE_CREAM_SANDWICH_MR1;
  ...
  static int get jellyBean => jni.Build_VERSION_CODES.JELLY_BEAN;
  ...
  static int get jellyBeanMR1 => jni.Build_VERSION_CODES.JELLY_BEAN_MR1;
  ...
  static int get jellyBeanMR2 => jni.Build_VERSION_CODES.JELLY_BEAN_MR2;
  ...
  static int get kitkat => jni.Build_VERSION_CODES.KITKAT;
  ...
  static int get kitkatWatch => jni.Build_VERSION_CODES.KITKAT_WATCH;
  ...
  static int get lollipop => jni.Build_VERSION_CODES.LOLLIPOP;
  ...
  static int get lollipopMR1 => jni.Build_VERSION_CODES.LOLLIPOP_MR1;
  ...
  static int get m => jni.Build_VERSION_CODES.M;
  ...
  static int get n => jni.Build_VERSION_CODES.N;
  ...
  static int get nMR1 => jni.Build_VERSION_CODES.N_MR1;
  ...
  static int get o => jni.Build_VERSION_CODES.O;
  ...
  static int get oMR1 => jni.Build_VERSION_CODES.O_MR1;
  ...
  static int get p => jni.Build_VERSION_CODES.P;
  ...
  static int get q => jni.Build_VERSION_CODES.Q;
  ...
  static int get r => jni.Build_VERSION_CODES.R;
  ...
  static int get s => jni.Build_VERSION_CODES.S;
  ...
  static int get sV2 => jni.Build_VERSION_CODES.S_V2;
  ...
  static int get tiramisu => jni.Build_VERSION_CODES.TIRAMISU;
  ...
  static int get upsideDownCake => jni.Build_VERSION_CODES.UPSIDE_DOWN_CAKE;
}
